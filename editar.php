  ...
  <div class="row content">
    <div class="col-sm-3 sidenav" style="background-color:black;" >
      ...
      <ul class="nav nav-pills nav-stacked" ><br>
        <li  class="active"><a href="#">Editar dados de utilizador</a></li>
        <li><a href="eliminar.php">Eliminar conta</a></li>
    ...
    <div class="col-sm-9"  style="overflow-y: auto;">
      <br> <br>
      <center><?php if (isset($_SESSION['status'])){echo $_SESSION['status'];unset($_SESSION['status']);}?></center>
    </div>
...
?>
      ...
      <center><form action="php/editarPHP.php" method="Post">

      <img style="margin-top: 15px;  margin-left:10px;   width: 200px;  border: 5px;" src="./img/outros/avatar.svg" >

        <h2 class="title">Edite-se aqui!</h2>
        <?php
     if (isset($_SESSION['mse'])){
         echo $_SESSION['mse'];
         unset($_SESSION['mse']);
     }
    ...
    ?>
           ...
           <div class="input-div one">
                 ...
                 <div class="div">
                    <h5>Nome</h5>
                    <input type="text" class="input" name="nome" placeholder="nome" value="<?php echo $_SESSION['login_user']['Nome']?>">
                 </div>
              </div>
              ...
              <div class="input-div two">
                 ...
                 <div class="div">
                    <h5>Telefone</h5>
                    <input type="tel" class="input" name="tele" value="<?php echo $_SESSION['login_user']['Telefone']?>">
                 </div>
             </div>
              ...
              <div class="input-div three">
                 ...
                 <div class="div">
                    <h5>Email</h5>
                    <input type="email" class="input" name="email"  value="<?php echo $_SESSION['login_user']['Email']?>">
                 </div>
              </div>
              <div class="input-div four">
                 ...
                 <div class="div">
                    <h5>Password</h5>
                    <input type="password" id="pass" class="input" name="pass" placeholder="Insira a pass nova!" value="<?php echo $_SESSION['password']?>">
                 </div>
              </div>
              ...
              <div class="input-div five">
                 ...
                 <div class="div">
                    ...
                    <input type="password" class="input" id="passC" name="passC" placeholder="Confira a pass nova!" value="<?php echo $_SESSION['password']?>" required>
                 </div>
              </div>
              ...
              <br>
              <?php
               if ($_SESSION['login_user']['tipo_cliente']== 'empresa') 
               {
            ...
            <?php }?>
              <div class="input-div six">
                 ...
                 <div class="div">
                    ...
                    <input type="text" class="input" id="enome" name="deno" value="<?php echo $_SESSION['login_user']['denominacao']?>">
                 </div>
              </div>
              <br>
